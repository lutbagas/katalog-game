  ...
  return (
    <nav className="w-full bg-gradient-to-r py-4 shadow-lg">
      <div className="max-w-8xl mx-auto flex items-center justify-between px-6">
        {/* Logo / Title */}
        <h1
          className="text-xl font-extrabold bg-gradient-to-r from-blue-600 via-purple-600 to-yellow-600 bg-clip-text text-transparent drop-shadow tracking-tight cursor-pointer"
          onClick={() => router.push("/")}
        >
          🎮 Katalog Game
        </h1>
